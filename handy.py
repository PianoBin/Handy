...
def displayResults():
	...
	global roll_angle_left, yaw_angle_left, pitch_angle_left, roll_angle_right, yaw_angle_right, pitch_angle_right, angle_count_left, angle_count_right
	print "roll angle on left hand: %f\nroll angle on right hand: %f" % ((roll_angle_left/angle_count_left), (roll_angle_right/angle_count_right))
	print "yaw angle on left hand: %f\nyaw angle on right hand: %f" % ((yaw_angle_left/angle_count_left), (yaw_angle_right/angle_count_right))
	print "pitch angle on left hand: %f\npitch angle on right hand: %f" % ((pitch_angle_left/angle_count_left), (pitch_angle_right/angle_count_right))
